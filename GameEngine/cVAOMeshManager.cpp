...
//	sVert_xyz_rgb* pVerticesToVBO = new sVert_xyz_rgb[ARRAYSIZE]
    ...
    glVertexAttribPointer( vpos_location,	// "vPosition"
                           ...
                           sizeof(sVert_xyz_rgb_Nxyz),	// size in bytes //sizeof(float) * 9,		// was 6 
						   (void*) offsetof( sVert_xyz_rgb_Nxyz, x ) );
//						   (void*) 0);
    ...
    glVertexAttribPointer(vcol_location,		// cColour
						   ...
						   GL_FALSE,
                           sizeof(sVert_xyz_rgb_Nxyz),	// size in bytes //sizeof(float) * 9,		// was 6 
						   (void*) offsetof( sVert_xyz_rgb_Nxyz, r ) );
//						   (void*) (sizeof(float) * 3));
    ...
    glVertexAttribPointer(vnorm_location,		// 
						   ...
						   GL_FLOAT, 
						   GL_FALSE,
                           sizeof(sVert_xyz_rgb_Nxyz),	//   9  size in bytes
						   (void*) offsetof( sVert_xyz_rgb_Nxyz, nx ) );
